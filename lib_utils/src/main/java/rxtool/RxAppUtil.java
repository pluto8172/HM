...
public class RxAppUtil {
    ...
    public static void installApp(final File file) {
        ...
        RxTool.getContext().startActivity(getInstallAppIntent(file, true));
    }
    ...
    public static void uninstallApp(final String packageName) {
        ...
        RxTool.getContext().startActivity(getUninstallAppIntent(packageName, true));
    }
    ...
    public static boolean isAppDebug() {
        return isAppDebug(RxTool.getContext().getPackageName());
    }
    ...
    public static boolean isAppSystem() {
        return isAppSystem(RxTool.getContext().getPackageName());
    }
    ...
    public static void launchApp(final String packageName) {
        if (isSpace(packageName)) return;
        RxTool.getContext().startActivity(getLaunchAppIntent(packageName, true));
    }
    ...
    public static void relaunchApp(final boolean isKillProcess) {
        PackageManager packageManager = RxTool.getContext().getPackageManager();
        Intent intent = packageManager.getLaunchIntentForPackage(RxTool.getContext().getPackageName());
    ...
    public static void launchAppDetailsSettings() {
        launchAppDetailsSettings(RxTool.getContext().getPackageName());
    }
    ...
    public static void launchAppDetailsSettings(final String packageName) {
        ...
        RxTool.getContext().startActivity(intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
    }
    ...
    public static Drawable getAppIcon() {
        return getAppIcon(RxTool.getContext().getPackageName());
    }
    ...
    public static String getAppName() {
        return getAppName(RxTool.getContext().getPackageName());
    }
    ...
    public static String getAppPath() {
        return getAppPath(RxTool.getContext().getPackageName());
    }
    ...
    public static String getAppVersionName() {
        return getAppVersionName(RxTool.getContext().getPackageName());
    }
    ...
    public static int getAppVersionCode() {
        return getAppVersionCode(RxTool.getContext().getPackageName());
    }
    ...
    public static Signature[] getAppSignature() {
        return getAppSignature(RxTool.getContext().getPackageName());
    }
    ...
    public static String getAppSignatureSHA1() {
        return getAppSignatureSHA1(RxTool.getContext().getPackageName());
    }
    ...
    public static String getAppSignatureSHA256() {
        return getAppSignatureSHA256(RxTool.getContext().getPackageName());
    }
    ...
    public static String getAppSignatureMD5() {
        return getAppSignatureMD5(RxTool.getContext().getPackageName());
    }
    ...
    public static AppInfo getAppInfo() {
        return getAppInfo(RxTool.getContext().getPackageName());
    }
     ...
     * @return the application's package information
     */
    public static RxAppUtil.AppInfo getApkInfo(final File apkFile) {
     ...
     * @return the application's package information
     */
    public static RxAppUtil.AppInfo getApkInfo(final String apkFilePath) {
    ...
    private static Intent getInstallAppIntent(final File file, final boolean isNewTask) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            String authority = RxTool.getContext().getPackageName() + ".fileProvider";
            data = FileProvider.getUriForFile(RxTool.getContext(), authority, file);
            intent.setFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);

        }
        RxTool.getContext().grantUriPermission(RxTool.getContext().getPackageName(), data, Intent.FLAG_GRANT_READ_URI_PERMISSION);
    ...
    private static Intent getLaunchAppIntent(final String packageName, final boolean isNewTask) {
        Intent intent = RxTool.getContext().getPackageManager().getLaunchIntentForPackage(packageName);
    ...
    private static String getForegroundProcessName() {
        ...
        if (android.os.Build.VERSION.SDK_INT > android.os.Build.VERSION_CODES.LOLLIPOP) {
            ...
            try {// Access to usage information.
                ApplicationInfo info = pm.getApplicationInfo(RxTool.getContext().getPackageName(), 0);
                AppOpsManager aom = (AppOpsManager) RxTool.getContext().getSystemService(Context.APP_OPS_SERVICE);
                //noinspection ConstantConditions
                ...
                UsageStatsManager usageStatsManager = (UsageStatsManager) RxTool.getContext().getSystemService(Context.USAGE_STATS_SERVICE);
