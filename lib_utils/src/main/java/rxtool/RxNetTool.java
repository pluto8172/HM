...
public class RxNetTool {
    ...
    public static int getNetWorkType(Context context) {
        ...
        @SuppressLint("MissingPermission") NetworkInfo ni = cm.getActiveNetworkInfo();// 获取当前网络状态
        ...
        if (ni != null && ni.isConnectedOrConnecting()) {
            ...
            netType = NETWORK_NO;
            RxToast.info(context, "当前无网络连接").show();
        }
        return netType;
    }
    ...
    public static boolean isAvailable() {
        NetworkInfo info = getActiveNetworkInfo(RxTool.getContext());
