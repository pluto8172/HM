...
import com.wl.pluto.lib_util.R;
...
public class RxToast {
    ...
    @ColorInt
    private static final int INFO_COLOR = Color.parseColor("#8B8B8B");
    ...
    public static void normal(@NonNull String message) {
        normal(RxTool.getContext(), message, Toast.LENGTH_LONG, null, false).show();
    }

    public static void normal(@NonNull String message, Drawable icon) {
        normal(RxTool.getContext(), message, Toast.LENGTH_LONG, icon, true).show();
    }
    ...
    public static void warning(@NonNull String message) {
        warning(RxTool.getContext(), message, Toast.LENGTH_LONG, true).show();
    }
    ...
    public static Toast warning(@NonNull String message, int duration, boolean withIcon) {
        return custom(RxTool.getContext(), message, getDrawable(RxTool.getContext(), R.mipmap.ic_error_outline_white_48dp), DEFAULT_TEXT_COLOR, WARNING_COLOR, duration, withIcon, true);
    }

    public static void info(@NonNull String message) {
        info(RxTool.getContext(), message, Toast.LENGTH_LONG, true).show();
    }
    ...
    public static Toast info(@NonNull String message, int duration, boolean withIcon) {
        return custom(RxTool.getContext(), message, getDrawable(RxTool.getContext(), R.mipmap.ic_info_outline_white_48dp), DEFAULT_TEXT_COLOR, INFO_COLOR, duration, withIcon, true);
    }

    public static void success(@NonNull String message) {
        success(RxTool.getContext(), message, Toast.LENGTH_LONG, true).show();
    }
    ...
    public static Toast success(@NonNull String message, int duration, boolean withIcon) {
        return custom(RxTool.getContext(), message, getDrawable(RxTool.getContext(), R.mipmap.ic_check_white_48dp), DEFAULT_TEXT_COLOR, SUCCESS_COLOR, duration, withIcon, true);
    }

    public static void error(@NonNull String message) {
        error(RxTool.getContext(), message, Toast.LENGTH_LONG, true).show();
    }
    ...
    public static Toast error(@NonNull String message, int duration, boolean withIcon) {
        return custom(RxTool.getContext(), message, getDrawable(RxTool.getContext(), R.mipmap.ic_clear_white_48dp), DEFAULT_TEXT_COLOR, ERROR_COLOR, duration, withIcon, true);
    }

    @CheckResult
    public static Toast normal(@NonNull Context context, @NonNull String message) {
        return normal(context, message, Toast.LENGTH_LONG, null, false);
    }

    @CheckResult
    public static Toast normal(@NonNull Context context, @NonNull String message, Drawable icon) {
        return normal(context, message, Toast.LENGTH_LONG, icon, true);
    }
    ...
    public static Toast warning(@NonNull Context context, @NonNull String message) {
        return warning(context, message, Toast.LENGTH_LONG, true);
    }
    ...
    public static Toast info(@NonNull Context context, @NonNull String message) {
        return info(context, message, Toast.LENGTH_LONG, true);
    }
    ...
    public static Toast success(@NonNull Context context, @NonNull String message) {
        return success(context, message, Toast.LENGTH_LONG, true);
    }
    ...
    public static Toast error(@NonNull Context context, @NonNull String message) {
        return error(context, message, Toast.LENGTH_LONG, true);
    }
     ...
     * @param str     要显示的字符串
     * @param isLong  Toast.LENGTH_LONG / Toast.LENGTH_LONG
     */
