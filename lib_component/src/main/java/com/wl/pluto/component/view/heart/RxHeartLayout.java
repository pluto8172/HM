 ...
 */
package com.wl.pluto.component.view.heart;
...
import com.wl.pluto.component.animation.RxAbstractPathAnimator;
import com.wl.pluto.component.animation.RxPathAnimator;
...
public class RxHeartLayout extends RelativeLayout {
    ...
    private void init(AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.RxHeartLayout, defStyleAttr, 0);
