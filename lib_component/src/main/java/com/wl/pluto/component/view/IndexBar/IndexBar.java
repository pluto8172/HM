package com.wl.pluto.component.view.IndexBar;
...
import com.wl.pluto.component.view.IndexBar.helper.IIndexBarDataHelper;
import com.wl.pluto.component.view.IndexBar.helper.IndexBarDataHelperImpl;
...
public class IndexBar extends View {
    ...
    public IndexBar setIsBold(boolean isBold) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mPaint.setColor(Color.parseColor("#45454B"));

        //设置index触摸监听器
        setmOnIndexPressedListener(new onIndexPressedListener() {
            @Override
            public void onIndexPressed(int index, String text) {
                RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) mPressedShowTextView.getLayoutParams();
                layoutParams.setMargins(0, mGapHeight * index, 0, 0);
    ...
    /**
     * 一定要在设置数据源{@link #setAuthorSourceDatas(List)}之前调用
     *
     * @param needRealIndex
     * @return
     */
    ...
    public IndexBar setAuthorSourceDatas(List<BaseIndexPinyinBean> mSourceDatas) {
