package com.wl.pluto.component.view.colorpicker.renderer;


import com.wl.pluto.component.view.colorpicker.ColorCircle;
...
public abstract class AbsColorWheelRenderer implements ColorWheelRenderer {
    ...
    protected List<ColorCircle> colorCircleList = new ArrayList<ColorCircle>();
