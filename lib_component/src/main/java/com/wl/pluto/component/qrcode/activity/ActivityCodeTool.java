package com.wl.pluto.component.qrcode.activity;
...
import com.wl.pluto.component.qrcode.tool.RxBarCode;
import com.wl.pluto.component.qrcode.tool.RxQRCode;
import com.wl.pluto.component.view.RxTitle;
import com.wl.pluto.component.view.ticker.RxTickerUtils;
import com.wl.pluto.component.view.ticker.RxTickerView;

import rxtool.RxActivityTool;
import rxtool.RxBarTool;
import rxtool.RxDataTool;
import rxtool.RxSPTool;
import rxtool.view.RxToast;

import static rxtool.RxConstants.SP_MADE_CODE;
import static rxtool.RxConstants.SP_SCAN_CODE;


/**
 * @author vondear
 */
public class ActivityCodeTool extends AppCompatActivity {
    ...
    private void updateScanCodeCount() {
        mRxTickerViewScan.setText(RxDataTool.stringToInt(RxSPTool.getContent(this, SP_SCAN_CODE)) + "", true);
    }

    private void updateMadeCodeCount() {
        mRxTickerViewMade.setText(RxDataTool.stringToInt(RxSPTool.getContent(this, SP_MADE_CODE)) + "", true);
    }
    ...
    private void initEvent() {
        ...
        mIvCreateQrCode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (RxDataTool.isNullString(str)) {
                    ...
                    RxSPTool.putContent(ActivityCodeTool.this, SP_MADE_CODE, RxDataTool.stringToInt(RxSPTool.getContent(ActivityCodeTool.this, SP_MADE_CODE)) + 1 + "");
        ...
        mLlScaner.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                 RxActivityTool.skipActivity(ActivityCodeTool.this, ActivityScanerCode.class);
            }
        });
