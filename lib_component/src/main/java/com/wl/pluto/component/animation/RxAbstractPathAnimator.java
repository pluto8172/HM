 ...
 */
package com.wl.pluto.component.animation;
...
public abstract class RxAbstractPathAnimator {
    ...
    public static class Config {
        ...
        public static Config fromTypeArray(TypedArray typedArray) {
            ...
            config.bezierFactor = typedArray.getInteger(R.styleable.RxHeartLayout_bezierFactor, res.getInteger(R.integer.heart_anim_bezier_factor));
            ...
            config.animDuration = typedArray.getInteger(R.styleable.RxHeartLayout_anim_duration, res.getInteger(R.integer.anim_duration));
            return config;
        }
    }
}
