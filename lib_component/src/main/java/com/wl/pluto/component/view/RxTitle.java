...
public class RxTitle extends FrameLayout {
    ...
    private void initView(final Context context, AttributeSet attrs) {
        ...
        try {
            ...
            //标题字体大小
            mTitleSize = a.getDimensionPixelSize(R.styleable.RxTitle_titleSize, RxSizeTool.dip2px(20));
            ...
            //左边图标
            mLeftIcon = a.getResourceId(R.styleable.RxTitle_leftIcon, R.mipmap.previous_icon);
            //右边图标
            ...
            //标题字体大小
            mLeftTextSize = a.getDimensionPixelSize(R.styleable.RxTitle_leftTextSize, RxSizeTool.dip2px(8));
            ...
            //标题字体大小
            mRightTextSize = a.getDimensionPixelSize(R.styleable.RxTitle_rightTextSize, RxSizeTool.dip2px(8));
    ...
    private void initAutoFitEditText() {
        ...
        mTvTitle.setMaxHeight(RxSizeTool.dip2px(55f));
