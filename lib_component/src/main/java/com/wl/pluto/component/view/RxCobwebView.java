...
import rxtool.model.ModelSpider;
...
public class RxCobwebView extends View {
    ...
    private void initEvent() {
        defalutSize = RxSizeTool.dp2px(defalutSize);
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        //标题字体大小
        mSpiderNameSize = a.getDimensionPixelSize(R.styleable.RxCobwebView_spiderNameSize, RxSizeTool.dp2px(16));
        a.recycle();
    }
