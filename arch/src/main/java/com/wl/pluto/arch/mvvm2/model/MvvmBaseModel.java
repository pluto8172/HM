...
import com.wl.pluto.arch.mvvm2.preference.BasicDataPreferenceUtil;
import com.wl.pluto.arch.mvvm2.utils.GsonUtils;
...
public abstract class MvvmBaseModel<F, T extends ArrayList> implements MvvmNetworkObserver<F>{
    ...
    public void getCachedDataAndLoad() {
        if (mCachedPreferenceKey != null && clazz != null) {
